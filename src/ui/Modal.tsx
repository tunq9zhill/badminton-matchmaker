...
export function Modal(props: {
  ...
  return (
    ...
    >
      <div
        className={`w-full max-w-md squircle rounded-t-3xl rounded-b-none border border-slate-200 bg-white shadow-xl transition-all duration-[450ms] ease-[cubic-bezier(0.22,1,0.36,1)] ${open ? "translate-y-0 opacity-100" : "translate-y-[110%] opacity-90"}`}
