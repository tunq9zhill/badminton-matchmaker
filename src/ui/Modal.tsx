...
export function Modal(props: {
  ...
  return (
    ...
    >
      <div
        className={`w-full max-w-md squircle rounded-t-3xl border border-slate-200 bg-white shadow-xl transition-all duration-300 ease-[cubic-bezier(0.38,1.37,0.33,1)] ${open ? "translate-y-0 opacity-100" : "translate-y-[110%] opacity-90"}`}
